...
- Support for the Gregorian and lunisolar calendars
- Event reminders for both calendar systems
- Holiday management
- Switching calendar views
- Import and export (iCal link)
- Multilingual support
- Changing date formats
- Extensions/add-ons for additional calendar systems
